...
// GET /api/messages/user/:userId — all sent + received for a user, newest first
...
// GET /api/messages/thread/:userId/:otherUserId — full conversation between two users, oldest first
